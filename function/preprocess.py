...
def get_corpus_matched_word_from_lexicon_tree(files, lexicon_tree):
    ...
    Return:
        total_words: all found matched words
    """
...
def get_pretrain_char_and_word(pretrain_word_path, pretrain_unigram_path, pretrain_char_and_word_path):
    lexicon_f = open(pretrain_word_path, 'r', encoding='utf-8')
    char_f = open(pretrain_unigram_path, 'r', encoding='utf-8')

    output_f = open(pretrain_char_and_word_path, 'w', encoding='utf-8')
