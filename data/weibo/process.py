        ...
        for line in lines:
            ...
            if len(line) == 2:
                ...
                if "B-" in label:
                    ...
                    entity_tmp.append(word)
                    if ("".join(entity_tmp), label.split("-")[-1].split(".")[0]) not in entities_tmp:
                        entities_tmp.append(("".join(entity_tmp), label.split("-")[-1].split(".")[0]))
                    labels.add(label.split("-")[-1].split(".")[0])
                    entity_tmp = []
